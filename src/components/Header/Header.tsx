...
const Header = () => {
  const [activeMobileMenu, setActiveMenuMobile] = useState(false);
  const logoClass = cn(s.logo, { [s.active__logo]: activeMobileMenu });
  function onClickBurger() {
    setActiveMenuMobile(!activeMobileMenu);
  }
  ...
  return (
    <header className={s.header + ' container'}>
      <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg" className={logoClass}>
      ...
      <MenuHeader activeMobileMenu={activeMobileMenu} />
      <Burger onClick={onClickBurger} activeMobileMenu={activeMobileMenu} />
    </header>
  );
};
